	...
	var Main = function (_React$Component) {
	    ...
	    _createClass(Main, [{
	        ...
	        value: function render() {
	            ...
	            var className = 'workarea ' + (this.props.goingBack ? 'back' : '') + ' ' + (this.props.currentNode.questionId ? 'question' : 'answer');
	...
	var Answer = function (_React$Component) {
	    ...
	    _createClass(Answer, [{
	        ...
	        value: function render() {
	            ...
	            var currentAnswer = this.props.answers.filter(function (answer) {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { id: 'solution',
	                    name: 'solution',
	                    type: 'hidden',
	                    value: this.props.answer.subtitle.length ? this.props.answer.title + ' - ' + this.props.answer.subtitle : this.props.answer.title
	                }),
	                [{
	...
	var Question = exports.Question = function (_React$Component) {
	    ...
	    _createClass(Question, [{
	        ...
	        value: function render() {
	            ...
	            var currentQuestion = this.props.questions.filter(function (question) {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'slideInner' },
	                _react2.default.createElement(_Title2.default, { currentNode: currentQuestion.title }),

	...
	function reducer() {
		...
		switch (action.type) {
			...
			case 'PARSE_ANSWER':
				...
				var newAnswers = state.answers.concat(action.value);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Slide = __webpack_require__(48);
	...
	var mapStateToProps = function mapStateToProps(state) {
	    return {
	        ...
	        requestSent: (0, _selectors.getRequestSent)(state),
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'a',
	                        { 'class': 'logoWrapper', href: 'http://www.attraversamentipedonali.it/' },
	                        _react2.default.createElement('img', { src: 'images/logo_apl-02.png', alt: 'torna al sito attraversamentipedonali.it' })
	                    )
	                ),
	                _react2.default.createElement(
	                    'div',
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'workarea ' + (this.props.goingBack ? 'back' : '') + ' ' + this.props.currentNode.type },
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'a',
	                        { 'class': 'ctaBtn backToSiteBtn', href: 'http://www.attraversamentipedonali.it/' },
	                        'Torna al sito www.attraversamentipedonali.it'
	                    )
	                )
	            );
	        }
...
/***/ function(module, exports) {
	...
	exports.getRequestSent = getRequestSent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SlideInner = __webpack_require__(50);
	...
	var Slide = function (_React$Component) {
	    ...
	    _createClass(Slide, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'slide ' + (this.props.requestSent ? 'hide' : ''), key: this.props.currentNode.id, ref: function ref(slide) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Answers = __webpack_require__(52);
	...
	var _Quotation = __webpack_require__(57);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getAnswerLabel(node, answers, i) {
	    ...
	    var selectedAnswerArr = node.answers.filter(function (answer) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        requestSent: function requestSent() {
	            return dispatch((0, _actions.requestSent)());
	        }
	    };
	};
	    ...
	    _createClass(Form, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'label',
	                    { className: 'quotation-field', htmlFor: 'name' },
	                    'Nome'
	                ),
	                _react2.default.createElement('input', { type: 'text', id: 'name', name: 'name', minLength: '2' }),
	                _react2.default.createElement(
	                    'label',
	                    { className: 'quotation-field' },
	                    'Cognome',
	                    _react2.default.createElement('input', { type: 'text', id: 'surname', name: 'surname', minLength: '2' })
	                ),
	                _react2.default.createElement(
	                    'label',
	                    { className: 'quotation-field' },
	                    'Societ\xE0* (ragione sociale)',
	                    _react2.default.createElement('input', { type: 'text', id: 'company', name: 'company', required: true, minLength: '2' })
	                ),
	                _react2.default.createElement(
	                    'label',
	                    { className: 'quotation-field' },
	                    'Indirizzo*',
	                    _react2.default.createElement('input', { type: 'text', id: 'address', name: 'address', required: true, minLength: '5' })
	                ),
	                _react2.default.createElement(
	                    'label',
	                    { className: 'quotation-field' },
	                    'Posizione',
	                    _react2.default.createElement('input', { type: 'text', id: 'role', name: 'role' })
	                ),
	                _react2.default.createElement(
	                    'label',
	                    { className: 'quotation-field' },
	                    'e-mail*',
	                    _react2.default.createElement('input', { type: 'email', id: 'email', name: 'email', required: true })
	                ),
	                _react2.default.createElement(
	                    'label',
	                    { className: 'quotation-field' },
	                    'Telefono',
	                    _react2.default.createElement('input', { type: 'tel', id: 'tel', name: 'tel' })
	                ),
	                _react2.default.createElement(
	                    'label',
	                    { className: 'quotation-field' },
	                    'Sito',
	                    _react2.default.createElement('input', { type: 'text', id: 'website', name: 'website' })
	                ),
	                _react2.default.createElement(
	                    'fieldset',
	                    { className: 'quotation-field' },
	                    ...
	                    _react2.default.createElement(
	                        'label',
	                        null,
	                        _react2.default.createElement('input', { type: 'radio', name: 'reason', id: 'peoject' }),
	                        'Elaborazione progetto'
	                    ),
	                    _react2.default.createElement(
	                        'label',
	                        null,
	                        _react2.default.createElement('input', { type: 'radio', name: 'reason', id: 'call' }),
	                        'Miglioria per gara d\'appalto'
	                    ),
	                    _react2.default.createElement(
	                        'label',
	                        null,
	                        _react2.default.createElement('input', { type: 'radio', name: 'reason', id: 'other' }),
	                        'Altro'
	                    )
	                ),
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement('textarea', { className: 'quotation-msg', id: 'msg', name: 'msg' })
	                ),
	                _react2.default.createElement(
	                    'button',
	                    { className: 'ctaBtn', type: 'submit' },
	                    'Invia'
	                )
	            );
	        }

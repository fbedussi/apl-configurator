...
/***/ function(module, exports) {
	...
	function getCurrentAnswer(state) {
	    return state.answers.filter(function (answer) {
	        return answer.id === state.currentNode.answerId;
	    })[0];
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LinkHome = __webpack_require__(52);
	
	var _LinkHome2 = _interopRequireDefault(_LinkHome);
	
	var _RequestNotification = __webpack_require__(53);
	...
	var mapStateToProps = function mapStateToProps(state) {
	    return {
	        ...
	        currentLanguage: (0, _selectors.getCurrentLanguage)(state),
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'appInner', lang: this.props.currentLanguage },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Answer = __webpack_require__(54);
	
	var _Answer2 = _interopRequireDefault(_Answer);
	
	var _Question = __webpack_require__(62);
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    this.props.currentNode.questionId && _react2.default.createElement(_Question2.default, { currentNode: this.props.currentNode }),
	                    this.props.currentNode.answerId && _react2.default.createElement(_Answer2.default, { currentNode: this.props.currentNode })
	                )
	            );
	            /*return (
	                <div className="slide">
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Back = __webpack_require__(56);
	
	var _Back2 = _interopRequireDefault(_Back);
	
	var _Images = __webpack_require__(57);
	
	var _Images2 = _interopRequireDefault(_Images);
	
	var _Recap = __webpack_require__(58);
	
	var _Recap2 = _interopRequireDefault(_Recap);
	
	var _QuotationButton = __webpack_require__(59);
	    ...
	    _createClass(Answer, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('p', { className: 'answer-text', dangerouslySetInnerHTML: { __html: answer.text } }),
	                _react2.default.createElement(
	                    'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapStateToProps = function mapStateToProps(state) {
	    return {
	        labels: (0, _selectors.getLabels)(state),
	        showForm: (0, _selectors.getShowForm)(state),
	        answer: (0, _selectors.getCurrentAnswer)(state)
	    };
	};
	    ...
	    _createClass(Form, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { id: 'solution', name: 'solution', type: 'hidden', value: this.props.answer.subtitle.length ? this.props.answer.title + ' - ' + this.props.answer.subtitle : this.props.answer.title }),
	                [{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Options = __webpack_require__(63);
	...
	var Options = function Options(_ref) {
	    ...
	    return _react2.default.createElement(
	        ...
	        options.map(function (label, i) {
	            return _react2.default.createElement(
	                'button',
	                { key: i, id: nodeId + '_' + i, className: 'question-optionBtn ctaBtn', onClick: function onClick(e) {
	                        return setAnswer(i);
	                    } },
	                label
	            );
